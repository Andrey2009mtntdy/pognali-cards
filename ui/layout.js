...
export const CARD1 = {
  ...
  specs:   { x: 42,   y: 775,  w: 340, h: 116, gap: 17, count: 3, radius: 26 },
  photo:   { x: 400,  y: 335,  w: 673, h: 890 },
  // Лента выше прежней, но нижний край на месте — растёт вверх, в свободное поле.
  footer:  { x: 42,   y: 1272, w: 1001, h: 128, radius: 28 },
};
...
export const SPEC_BOX = {
  icon:  { x: 26, y: 30, size: 56 },
  value: { x: 100, y: 18, h: 54 },
  label: { x: 102, y: 76, h: 24 },
};

// Внутренняя раскладка колонки нижней ленты (от угла колонки)
export const FOOTER_BOX = {
  icon:  { x: 28, size: 48 },
  label: { x: 92, y: 30, h: 27 },
  value: { x: 92, y: 64, h: 36 },
};

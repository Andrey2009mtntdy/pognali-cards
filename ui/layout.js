...
export const CARD2 = {
  ...
  brand:    { x: 42,  y: 10,  w: 530, h: 106 },
  model:    { x: 42,  y: 88,  w: 530, h: 102 },
  // Правый столбец выровнен с левым: «КОМПЛЕКТАЦИЯ» начинается на одном
  // уровне с брендом, «И ОСОБЕННОСТИ» заканчивается на одном уровне с моделью.
  // Строки заданы каждая своей зоной — доли от общей высоты такого совпадения
  // не давали, потому что кегль строк ограничен шириной, а не высотой.
  divider:  { x: 600, y: 12,  h: 154 },
  title:    { x: 615, y: 9,   w: 409, h: 60 },    // КОМПЛЕКТАЦИЯ
  title2:   { x: 615, y: 123, w: 409, h: 60 },    // И ОСОБЕННОСТИ

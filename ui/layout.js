...
export const BATTERY_BOX = {
  tile:  { x: 0, y: 10, size: 143, radius: 36 },
  icon:  { inset: 38 },
  type:  { x: 174, y: 17, h: 74 },
  value: { x: 177, y: 94, h: 61 },
};
...
export const FOOTER_BOX = {
  icon:  { x: 28, size: 96 },
  label: { x: 140, y: 30, h: 27 },
  value: { x: 140, y: 64, h: 36 },
};
